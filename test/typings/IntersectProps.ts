import { DefaultExpandMode, IntersectPropsWhileConserve, UnionMutualProps, OptionalKeys, IntersectProps } from "../../src/utilityTypes";
import { ExtractObject } from "@teronis/ts-definitions";
...
type tgg1 = IntersectPropsWhileConserve<igg1, igg2>;
type tgg1_1 = IntersectProps<igg1, igg2>;
declare const cgg1: tgg1;
// cgg1.
type tgg2 = IntersectPropsWhileConserve<igg1, igg3>;
declare const cgg2: tgg2;
// cgg2.;

type tgg3 = UnionMutualProps<igg1, igg3>;
type tgg3_0 = OptionalKeys<igg1>;
